        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="frame-gold"><h2 className="text-3xl font-bold mb-8 text-primary">عن المكتبة</h2><div className="space-y-6">
              ...
              <div><h3 className="text-xl font-bold mb-3 text-primary">التواصل</h3><div className="space-y-2">{bookstore.userEmail && <p className="text-foreground"><span className="font-semibold">البريد الإلكتروني:</span> {bookstore.userEmail}</p>}{bookstore.email && <p className="text-foreground"><span className="font-semibold">بريد المكتبة:</span> {bookstore.email}</p>}{bookstore.phone && <p className="text-foreground"><span className="font-semibold">الهاتف:</span> {bookstore.phone}</p>}</div></div>
            </div></div>
